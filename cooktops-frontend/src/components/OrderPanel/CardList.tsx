  ...
  return (
    <div className="basis-0 grow min-h-px min-w-px relative shrink-0">
      <div className="bg-clip-padding border-0 border-transparent border-solid box-border content-stretch flex flex-col gap-1 items-start justify-center leading-[0] p-0 relative text-left w-full">
        <div
          className="css-xb5jc6 font-['Plus_Jakarta_Sans:Medium',sans-serif] font-medium min-w-full relative shrink-0 text-foreground text-[16px]"
        ...
        <div
          className="css-lbkhcf font-['Plus_Jakarta_Sans:Regular',sans-serif] font-normal min-w-full relative shrink-0 text-[14px] text-muted-foreground"
          style={{ width: "min-content" }}
        >
  ...
  return (
    <div className="relative shrink-0">
      <div className="bg-clip-padding border-0 border-transparent border-solid box-border content-stretch flex flex-col items-start justify-start p-0 relative">
        <div className="css-lbkhcf font-['Plus_Jakarta_Sans:Regular',sans-serif] font-normal leading-[0] relative shrink-0 text-[14px] text-left text-muted-foreground text-nowrap w-full">
    ...
    <div className="relative shrink-0 w-full">
      <div className="flex flex-row items-center justify-center relative size-full">
        <div className="box-border content-stretch flex flex-row gap-2.5 items-center justify-center px-0 py-10 relative w-full">
          <div className="basis-0 css-lbkhcf font-['Plus_Jakarta_Sans:Regular',sans-serif] font-normal grow leading-[0] min-h-px min-w-px relative shrink-0 text-[14px] text-center text-muted-foreground">
