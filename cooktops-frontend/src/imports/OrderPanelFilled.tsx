...
type BackgroundImage240Props = {
  additionalClassNames?: string[];
};

function BackgroundImage240({
  children,
  additionalClassNames = [],
}: React.PropsWithChildren<BackgroundImage240Props>) {
  return (
    <div
...
function BackgroundImage139({ children }: React.PropsWithChildren<object>) {
  return (
...
type BackgroundImage122Props = {
  additionalClassNames?: string[];
};

function BackgroundImage122({
  children,
  additionalClassNames = [],
}: React.PropsWithChildren<BackgroundImage122Props>) {
  return (
...
function StatelayerBackgroundImage1({ children }: React.PropsWithChildren<object>) {
  return (
    <BackgroundImage106>
...
function InfoBackgroundImage2({ children }: React.PropsWithChildren<object>) {
  return (
    <div className="basis-0 grow min-h-px min-w-px relative shrink-0">
...
type InfoBackgroundImage1Props = {
  additionalClassNames?: string[];
};

function InfoBackgroundImage1({
  children,
  additionalClassNames = [],
}: React.PropsWithChildren<InfoBackgroundImage1Props>) {
  return (
    <div className={clsx("relative shrink-0", additionalClassNames)}>
      <div className="absolute border-[#e5e8eb] border-[0px_0px_1px] border-solid inset-0 pointer-events-none" />
      <div className="relative size-full">
...
function StatelayerBackgroundImage({ children }: React.PropsWithChildren<object>) {
  return (
...
function TabcontentsBackgroundImage({ children }: React.PropsWithChildren<object>) {
  return (
    <div className="basis-0 grow min-h-px min-w-px relative shrink-0">
...
function TablecellBackgroundImageAndText({
  text,
  additionalClassNames = [],
}: TablecellBackgroundImageAndTextProps) {
  return (
    <div
...
function ValueBackgroundImageAndText({
  text,
...
function TitleBackgroundImageAndText({
  text,
}: TitleBackgroundImageAndTextProps) {
  return (
    <BackgroundImage139>
      <div
    ...
    >
      <div className="flex flex-row items-center relative size-full">
        <div className="box-border content-stretch flex flex-row h-[72px] items-center justify-between px-4 py-2 relative w-80">
          <InfoBackgroundImage
            text="3 itens - R$ 30,00"
            text1="Pedido #12346"
          />
          <TimeBackgroundImageAndText text="10:05" />
        </div>
      </div>
    </div>
  );
...
function Info3() {
  return (
    <InfoBackgroundImage3>
      <TitleBackgroundImageAndText text="Detalhes do pedido" />
    </InfoBackgroundImage3>
  );
}
...
function Info4() {
  return (
    <InfoBackgroundImage1 additionalClassNames={["[grid-area:1/1]"]}>
      ...
      <ValueBackgroundImageAndText text="Balcão" />
    </InfoBackgroundImage1>
  );
}
...
function Info5() {
  return (
    <InfoBackgroundImage1 additionalClassNames={["[grid-area:1/2]"]}>
      ...
      <ValueBackgroundImageAndText text="10:00 AM" />
    </InfoBackgroundImage1>
  );
}
...
function Info6() {
  return (
    <InfoBackgroundImage1 additionalClassNames={["[grid-area:2/1]"]}>
      ...
      <ValueBackgroundImageAndText text="Lal de lal de lal" />
    </InfoBackgroundImage1>
  );
}
...
function Info7() {
  return (
    <InfoBackgroundImage1 additionalClassNames={["[grid-area:2/2]"]}>
      ...
      <ValueBackgroundImageAndText text="44 98888-7777" />
    </InfoBackgroundImage1>
  );
}
...
function Info9() {
  return (
    <InfoBackgroundImage3>
      <TitleBackgroundImageAndText text="Itens" />
    </InfoBackgroundImage3>
  );
}
...
function Info10() {
  return (
    <InfoBackgroundImage3>
      <TitleBackgroundImageAndText text="Total" />
    </InfoBackgroundImage3>
  );
}
...
function Info11() {
  return (
    <InfoBackgroundImage2>
      ...
      <ValueBackgroundImageAndText text="R$ 3,00" />
    </InfoBackgroundImage2>
  );
}
...
function Info12() {
  return (
    <InfoBackgroundImage2>
      ...
      <ValueBackgroundImageAndText text="R$ 0,25" />
    </InfoBackgroundImage2>
  );
}
